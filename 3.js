  ...
  Promise.allSettled([promise1(), promise2()])
    ...
    .then((results) => {
      ...
      results.forEach((result) => {
        console.log(
          `Status: ${result.status}, Meaning: ${result.value || result.reason}`
        );
        console.log(result);
      });
    })
...
// Status: fulfilled, Meaning: Проміс 1 виконано
// { status: 'fulfilled', value: 'Проміс 1 виконано' }
// Status: rejected, Meaning: Проміс 2 відхилено
// { status: 'rejected', reason: 'Проміс 2 відхилено' }
